...
Alan é conhecido por se referir à temperatura do giro da maçã como "Mais quente que o sol!". 
De acordo com o site space.com, a temperatura da coroa solar é de 2.000.000 graus C, 
mas vamos ignorar a ciência por enquanto.
...

{
  ...
  console.log(assert(sample, "It's hotter than the sun!!"));
}

{
  ...
  console.log(apple(sample));
  console.log(
    assert(sample, "Help yourself to a honeycomb Yorkie for the glovebox.")
  );
}
